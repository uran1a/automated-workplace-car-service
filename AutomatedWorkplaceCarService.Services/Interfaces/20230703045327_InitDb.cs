        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specializations_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    StartWork = table.Column<DateTime>(type: "Date", nullable: false),
                    EndWork = table.Column<DateTime>(type: "Date", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "PostId", "ServiceId" },
                values: new object[,]
                {
                    { 1, 2, 2 },
                    { 2, 3, 3 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specializations_PostId",
                table: "Specializations",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Specializations_ServiceId",
                table: "Specializations",
                column: "ServiceId");
